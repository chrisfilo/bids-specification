...
| ReferenceIndex | REQUIRED when an index into a 4D (`Reference` or `NonstandardReference`) file is used. Used to index into a time-varying spatial-reference file.                                                                                                                                                                                                                 |
